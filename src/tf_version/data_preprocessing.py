...
def tokenize_data(file_names,origin_labels=None,delete_repeated_labels_filename=None):
    print('Tokenizing the data ...')
    repeated_line_ids=set()
    if origin_labels!=None:
    ...
    for file_name in file_names:
        ...
        for index, ite in enumerate(label_file):
            if index not in repeated_line_ids and origin_labels!=None:
...
if __name__ == '__main__':
    ...
    #tokenize_data([config.TRAIN_DATA_NAME])
